...
const TopForm = () => {
  ...
  return (
    <div className="bg-slate-400 flex justify-center items-center gap-6 flex-col p-12 rounded-xl ">
      <h1 className="text-3xl text-orange-700" >Todo</h1>
      <div className="rounded-xl flex  bg-slate-300">
        <input className=" bg-slate-300 rounded-lg px-4 py-2 outline-none" type="text" placeholder="schreib hier..."
          value={task}
          onChange={getTask} />
